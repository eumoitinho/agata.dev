...
export interface DeploymentContext {
  ...
  env: import('./index').AzureBindings
...
/**
 * Deployment state for persistence (stored in Azure Cosmos DB)
 */
...
/**
 * Deploy step result (using Cloudflare Workers from Azure)
 */
...
export interface DeploymentResult {
  ...
  duration: number
  /** Final deployment state (only available when deployment context is accessible) */
  state?: DeploymentState
}
